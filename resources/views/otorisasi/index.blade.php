...
<div class="row mt-4">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            ...
            <!-- Add the search form -->
            <form action="{{ route('otorisasi.search') }}"method="get" class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12 mt-4 px-4">
                    ...
                    <table class="table table-striped table-bordered first">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $otorisasi->pe_rps}}</td>
                                <td>{{ $otorisasi->koprodi}}</td>
                                <td>{{ $otorisasi->kajur}}</td>
                                {{-- <td>{{ $pengajuan->nik}}</td>
                                ...
                                <td class="text-center">
                                    <a href="/otorisasi/{{ $otorisasi->id }}/edit" class="btn btn-primary btn-sm"><i class="fas fa-pencil-alt"></i> Update</a>

                                    <form action="/otorisasi/{{ $otorisasi->id }}" method="post" class="d-inline">
                                        @method('DELETE')
                                        @csrf
            ...
            <div  class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12 mt-2 px-4">
                @if (isset($otorisasis) && $otorisasis instanceof \Illuminate\Pagination\LengthAwarePaginator)
                    {{ $otorisasis->links('pagination::bootstrap-5') }}
                @endif
            </div>
        </div>
    </div>
