                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered first">
                        ...
                        <tbody>
                           ...
                           @foreach ($all_nilai_kuis as $item)
                           <tr id="items">
                               <td class="text-center">{{ $loop->iteration}}</td>
                               <td>{{ $item->mahasiswa->nama }}</td>
                               <td><a href="" class="editablekuis" data-type="text" data-name="kuis" data-pk="{{ $item->id }}">{{ $item->kuis }}</td>
                               <td class="text-center">
                               <form action="/nilaikuis/hapustugas{{ $item->id }}" method="post" class="d-inline">
                                   @method('DELETE')
                                   @csrf
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form id="form_create_nilai_kuis">
                ...
                <input type="number"  class="form-control  @error('kuis') is-invalid @enderror" value="{{old('kuis')}}" name="kuis" id="kuis" >
                @error('kuis')
