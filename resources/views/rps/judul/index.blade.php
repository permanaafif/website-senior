    ...
    <div class="row">
        <div class="col-lg">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ route('data-judul.create') }}" class="btn btn-primary btn-sm">
                            ...
                            <tbody>
                                @foreach ($juduls as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('data-judul.destroy', $data->id) }}" method="POST"
                                                class="d-flex">
                                                @method('DELETE')
                                                @csrf
                                                <a href="{{ route('data-judul.edit', $data->id) }}"
