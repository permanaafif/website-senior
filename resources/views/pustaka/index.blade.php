    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/pustaka/{{ $pustaka->id }}/edit" class="btn btn-primary btn-sm"><i class="fas fa-pencil-alt"></i> Update</a>

                                    <form action="/pustaka/{{ $pustaka->id }}" method="post" class="d-inline">
                                        @method('DELETE')
                                        @csrf
            ...
            <div  class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12 mt-2 px-4">
                @if (isset($pustakas) && $pustakas instanceof \Illuminate\Pagination\LengthAwarePaginator)
                    {{ $pustakas->links('pagination::bootstrap-5') }}
                @endif
            </div>
        </div>
    </div>
