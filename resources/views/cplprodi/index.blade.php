...
<div class="row mt-4">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            ...
            <form action="{{ route('cplprodi.search') }}" method="get" class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12 mt-4 px-4">
                    ...
                    <table class="table table-striped table-bordered first">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $cpl_prodi->judul}}</td>
                                <td>{{ $cpl_prodi->isijudul}}</td>
                                ...
                                <td class="text-center">
                                    <a href="/cplprodi/{{ $cpl_prodi->id }}/edit" class="btn btn-primary btn-sm"><i class="fas fa-pencil-alt"></i> Update</a>

                                    <form action="/cplprodi/{{ $cpl_prodi->id }}" method="post" class="d-inline">
                                        @method('DELETE')
                                        @csrf
